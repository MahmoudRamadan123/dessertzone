...
$query="SELECT *, items.name as name from items Left Join categories ON categories.id = items.category_id where categories.name = 'Ice Cream'";
...
<!-- ice section starts .............................................-->
    ...
    margin-bottom: 20px;">
            <input type="text" name="search" id="ice-search-input" placeholder="Search items" class="search-input" style="
    /* border: black; */
...
let iceSearch = document.getElementById("ice-search-input");
iceSearch.addEventListener('keyup', function(){
  if(iceSearch.value!=''){
    resultsContainer.classList.remove('hidden');
    boxContainer.classList.add('hidden');
    searchData("dark-choc.php", iceSearch.value, "Ice Cream");
  }
  else{
...
<!-- Footer section starts .......................................-->
          ...
          <script type="text/javascript" src="iced-drinks.js"></script>

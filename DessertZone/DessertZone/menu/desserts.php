...
$query="SELECT *, items.name as name from items Left Join categories ON categories.id = items.category_id where categories.name = 'Desserts'";
...
<div class="progress-container">
    ...
    margin-bottom: 20px;">
            <input type="text" name="search" id="dessert-search-input" placeholder="Search items" class="search-input" style="
    /* border: black; */
...
let dessertSearch = document.getElementById("dessert-search-input");
dessertSearch.addEventListener('keyup', function(){
  if(dessertSearch.value!=''){
    resultsContainer.classList.remove('hidden');
    boxContainer.classList.add('hidden');
    searchData("dark-choc.php", dessertSearch.value, "Desserts");
  }
  else{
